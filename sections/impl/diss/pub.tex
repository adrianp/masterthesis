...
\begin{itemize}
  ...
  \item The OA \texttt{annotatedBy} contains information regarding
        ...
        namely an IRI pointing to a complete profile\footnote{This is currenly
...
from the fieldsd escribed above, also contains the entire context definitions;
this is denoted internaly as the \textit{``full''} format. Other formats, such
