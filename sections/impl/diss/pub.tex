...
this is denoted internally as the \textit{``inline''} or \textit{``full''}
format. Other formats, such as the expanded or RDF/ N-Quads ones, can be
obtained by simple calls to the PyLD API \cite{ref:pyld}. An example of an
